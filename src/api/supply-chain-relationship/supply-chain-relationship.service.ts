...
import { GetSupplyChainRelationshipListQuery } from './dtos';
import { SupplyChainRelationshipList, UIFunctionOutput } from '@shared/interfaces';
...
@Injectable()
export class SupplyChainRelationshipService {
  constructor(
  ...
  async getSupplyChainRelationshipList(
    ...
    userType: UserTypes,
    query: GetSupplyChainRelationshipListQuery,
  ): Promise<SupplyChainRelationshipList> {
    const uiKey = uiKeys.supplyChainRelationship.list.key;
    ...
    const message: UIFunctionOutput = {
      ...
      ui_function: uiKeys.supplyChainRelationship.list.function,
    ...
    return plainToInstance(SupplyChainRelationshipList, {
      supplyChainRelationshipList: results.SupplyChainRelationshipList?.SupplyChainRelationship || [],
    });
  }
}
